...
* Click the **Linux_Keystore_Cert_Discovery** workflow
    ...
    * Under **keystorePath** name, click **Eye** icon as shown below to reveal the text, for Default value, type `"/opt/tomcat/ssl/server.jks"`
    ...
    ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/cw-jks-certdiscovery-keystorepath.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/cw-save-workflow-with-configs.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/cw-run-workflow.png)

* The workflow will complete its execution and return **202 Accepted** as message in **Logs** section below 

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/cw-jks-certdiscovery-execution.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/concert-operations-dimension-certificates.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/certificate-props-after-expanding-twistie.png)

* Click **the Certificate Serial Number** to navigate to the Certificate's **Keystore entries UI**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/concert-certificate-serial-number.png) 

* You will get into **Keystore entries UI** for a Certificate after performing previous action.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/concert-certificate-keystore-entries-ui.png)

* Click 3 vertical dots at the right bottom of Certificate UI, to perform **Update attributes** action for the Certificate.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/concert-certificates-3vertical-dots.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/5-certificate-discovery-javaKeyStore/images/github-issues-for-exp-certificates.png)
