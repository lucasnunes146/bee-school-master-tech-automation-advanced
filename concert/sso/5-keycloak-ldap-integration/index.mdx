...
![Create Realm](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-create-concert-realm.png)
...
![Create Client](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-create-client.png)
...
![Create Client](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-create-client-values.png)
...
![Create Client Capability](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-create-client-capability.png)
...
![Create Client Login](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-create-client-login.png)
...
![Create Client Summary](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-create-client-summary.png)
...
![Add LDAP Provider](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-add-provider.png)
...
![Keycloak Userfed General Settings](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-general-settings.png)
...
![Keycloak Userfed Conn and Auth Settings](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-general-settings-block2.png)
...
![Keycloak User Federation LDAP Bind Settings](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-bind-settings.png)
...
![Keycloak User Federation LDAP Search Part 1](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-search-and-updating.png)
   
![Keycloak User Federation LDAP Search Part 2](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-part2-search-and-updating.png)
...
![Keycloak User Federation LDAP Sync Settings](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-sync-kerberos.png)
...
![Keycloak User Federation LDAP Sync Kerberos](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-sync-kerberos-part2.png)
...
![Keycloak adv](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-sync-part1-cache-adv.png)
...
![Keycloak adv](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-ldap-sync-cache-adv.png)
...
![Test Connection Success](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-test-connection.png)
...
![Test Authentication Success](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-test-authentication.png)
...
![Keycloak User Federation openldap tile](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-openldap-new-tile.png)
...
![Sync Users](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-sync-all-users.png)

4. Wait for the synchronization to complete

![Sync all Users message](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-sync-all-users-message.png)
...
![Users List](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-view-all-users.png)
...
![User Details](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-alice-ldap-user.png)
...
![UserFed OpenLDAP](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-openldap.png)

2. Click the **Mappers** tab
3. You'll see several default mappers already created

![Mapper](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-mapper-add.png)
...
![Mapper Add](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-new-mapper-add.png)

2. Select **group-ldap-mapper** from the mapper type dropdown

![Mapper Select Group Ldap](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-mapper-group-ldap.png)
...
![Group Mapper Configuration Part 1](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-concert-group-part1.png)
![Group Mapper Configuration Part 2](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-concert-group-part2.png)
...
![Sync Groups](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-sync-groups.png)

4. You should see a message, `Data successfully synced ...`  on top right corner indicating groups were synchronized
 
![Sync Groups Result](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-userfed-sync-groups-message.png)
 
![Sync Groups Result](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-group-sync-result.png)
...
![Groups List](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-ldap-groups.png)
...
![Group Members Corporate IT](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-groups-corporate_it_staff.png)

![Group Members HR](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-groups-hr_staff.png)

![Group Members Sales](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-groups-sales_staff.png)
...
![User Groups Membership](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-alice-user-groups-membership.png)
...
![Keycloak Test Client Gen Settings](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-test-client-general-settings.png)
...
![Keycloak Test Client Cap Configs](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-test-client-cap-configs.png)
...
![Keycloak Test Client Login Settings](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/keycloak-test-client-login-settings.png)
...
![Curl OIDC Test Client Output](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/sso/5-keycloak-ldap-integration/images/curl-oidc-test-client-output.png)
