...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/os-patch-management/2-lab-environment/images/architecture3.png)
...
**Example**  
![ServiceNow Developer Request Instance](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/os-patch-management/2-lab-environment/images/requestInstance.png)

3. Select the **latest release** for your instance and click **Request**.

**Example**  
![ServiceNow Release Selection](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/os-patch-management/2-lab-environment/images/location.png)

4. After a few minutes, your developer instance will be online. Click **Manage my instance**.

**Example**  
![ServiceNow Developer Online](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/os-patch-management/2-lab-environment/images/online.png)

5. Copy the **Instance URL**, **Username**, and **Password** from your developer instance.

**Example**  
![ServiceNow Developer Credentials](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/os-patch-management/2-lab-environment/images/credentials.png)
