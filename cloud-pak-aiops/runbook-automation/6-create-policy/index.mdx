...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/operate_menu.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/policy_triggers.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/policy_condition_sets.png)

- Scroll down to **Assign Runbook(s)**
- Check: **Branched example** from the list of available runbooks

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/assign_runbooks.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/runbooks_selected.png)

- Scroll back to the top, checking your settings as you go
- Click the **Create policy** button to save your new runbook:

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/create_policy.png)

- If you type **Branched** into the search box, you should see your newly created policy:

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/cloud-pak-aiops/runbook-automation/6-create-policy/images/policy_created.png)
