...
![architecture-kubeturbo-agent](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/architecture-kubeturbo.png)
...
1. In your browser, navigate to your Apps Single Node OpenShift console by
   ...
   ![untrusted-cert-advance](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/advance-cert-warning.png)
...
1. Search for `kubeturbo` and select the **Certified** KubeTurbo operator:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/searchKubeturboCertified.png)

1. Select and click on the **Install** button:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboInstall-1.png)
...
1. Select options as below:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboInstall-2.png)

1. Click on the **Approve** button when the _Manual approval required_ prompt
   appears:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboInstall-3.png)
...
1. The operator will install and when it's ready you can view the operator
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboInstall-4.png)
...
1. When viewing the deployed operator, click on **Create instance**:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-1.png)
...
1. To configure this instance click on the **YAML view** option:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-2.png)
...
1. Replace all the content in the YAML editor view with the YAML config below
   ...
   **DO NOT CLICK CREATE YET!!**
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-3.png)
...
1. Now, replace the text
   ...
   **How to get the Turbonomic Server URL:**
   ...
   1. Navigate to **Networking** -> **Routes**, ensure the **turbonomic**
      ...
      ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/topology-processor-route.png)

   1. Go back to your YAML editor view in Step 3 earlier. Assign it as the
      **turboServer** value:

      ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-4.png)
...
1. Next, replace the text `<your turbonomic server version>` with the actual
   ...
   **How to get the Turbonomic Server Version?**
   ...
   1. Navigate to **Networking** -> **Routes**, select the **turbonomic
      ...
      ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/turboApiRoute.png)

   1. It will bring up the Turbonomic UI page as below. Check the version listed
      at the bottom of the page.

      ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/turbo-login-version.png)
   ...
   1. Go back to your YAML editor view in Step 3 earlier. Assign the value to:
      ...
      ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-5.png)
...
1. Next, replace the values of `<your turbonomic server password>` and
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-6.png)
...
1. Then set a cluster name for the **targetName**, e.g.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/completed-kubeturbo-form.png)
...
1. When you have applied your configuration you will see that you have created
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/kubeturboCreateInstance-8.png)
...
1. Then click on the **kubeturbo-release** pod.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/validateDeployment-1.png)
...
1. Then click on **Logs** to validate that the probe has successfully registered
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/turbo-probe-registration-success.png)
...
1. Validate the target in the Turbonomic Server UI
   ...
   - Go to your **Turbonomic Server UI** -> **Settings** -> **Target
     ...
     ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/validate-deployment-by-name.png)
...
1. Finally validate that **Kubeturbo** is discovering additional entitites from
   ...
   - Navigate to the **Robot Shop** _Business Application_
     ...
     ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/nav-to-kubeturbo-check.png)
   ...
   - Confirm the SNO **Virtual Machine** and other Kubernetes entities have now
     ...
     ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/ui-and-k8s-data-target-lab/4-kubeturbo/images/verify-kubeturbo-robot-shop.png)
