...
![architecture-turbo-server-install](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/architecture-turbo-server-install.png)
...
![open-terminal](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/open-terminal.png)
...
1. Run the following commands to check you are in the right place:
   ...
   ![aiops-cluster-check](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/aiops-cluster-check.png)
...
1. Open a Firefox browser window
   ...
   ![open firefox](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/open-firefox.png)
...
1. Use the Firefox Bookmark **OCP Dashboard** to open your OpenShift AIOps OCP
   ...
   ![untrusted-cert-advance](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/advance-cert-warning.png)
...
1. Launch the operator pod:
   ...
   **Certified** operator
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/turbo-operator-1.png)

1. Select and click on the `Install` button:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/turbo-operator-2.png)
...
1. Select options as below:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/turbo-install-operator.png)
...
1. The first time you log in to Turbonomic, you will be prompted to create a
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/firstTimeLogin.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/license1.png)
...
1. Click on `IMPORT LICENSE` button and browse for the newly created license
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/turbo-license.png)

1. Then click on `Save` button. You will see the page below if it's successful:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/3-installation/images/license2.png)
