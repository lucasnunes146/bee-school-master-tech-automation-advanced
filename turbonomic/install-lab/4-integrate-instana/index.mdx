...
![architecture-connect-instana-turbo](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/architecture-connect-instana-turbo.png)
...
1. Create a new API token by selecting:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/addApiToken.png)
...
1. In the create API token page, enter a name for your token, e.g.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/apiToken2.png)

1. Copy the generated API token to be used in later steps:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/apiToken1.png)

1. Click on the **Save** button. The API token is created.

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/apiToken3.png)

1. In the Turbonomic console, go to **Settings** -> **Target Configuration**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/turbo-target-configuration.png)

1. Click on the **NEW TARGET** button (top-right) and then select **Applications
   and Databases**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/application-and-databases.png)

1. Click on **Instana**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/instanaTarget.png)
...
1. Add the Instana Target details:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/add-instana-target.png)
   ...
   ![target added](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/instana-target-added.png)
   ...
   ![target added data](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/install-lab/4-integrate-instana/images/instana-target-data.png)
