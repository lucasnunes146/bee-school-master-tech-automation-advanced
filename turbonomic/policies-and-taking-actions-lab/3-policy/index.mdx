...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/open-firefox.png)
...
1. Click on **Settings** -> **Groups**:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/turbo-groups-1.png)

1. Click on **NEW GROUP**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/groups-2.png)

1. Click on **Container Spec**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/groups-3.png)
...
1. Enter the group name as `Robot Shop Group` and select the **Dynamic** type:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/groups-4.png)
...
1. Select filter **Equals** and enter the expression `robot-shop` then click the
   **Apply** button:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/groups-5.png)

1. Click on the **SAVE GROUP** button:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/groups-6.png)

   You should now see the **Robot Shop Group** newly created.

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/groups-7.png)
...
1. Click on **Settings** and select **Policies**:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/turbo-settings-policies.png)

1. Then click on **NEW AUTOMATION POLICY**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-1.png)

1. Select **Container Spec** as the policy type for the Robot Shop application:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-2.png)

1. Fill in the name as `Robot Shop Container Spec Policy` and click on **ADD
   CONTAINER SPEC GROUPS**:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-3.png)

1. Select the **Robot Shop Group** checkbox and click on the **SELECT** button.

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-4.png)

1. Expand the **SCALING CONSTRAINTS** section:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-5.png)

1. Configure the scaling constraints as in the image below:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-6.png)
...
1. The scoped policy you have created can be found in the **Automation
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-7.png)

1. The **Imported Placement Policies** category is specifically to filter for
   imported on-prem policies:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/turbo-imported-policies.png)
...
1. The **Defaults** category represents the policies that govern entire entity
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/turbo-imported-defaults.png)
...
1. Now go back to the Turbonomic dashboard by clicking the green **on** at the
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/policy-8.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/turbo-edit-policy.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/3-policy/images/turbo-delete-policy.png)
