...
1. Navigate to **Kubernetes**.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/kubernetes.png)

1. Select your Single Node OpenShift Apps cluster called **apps_cluster**.

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/instana-apps-cluster.png)

1. Under the **Namespaces** tab, select **robot-shop**.

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/instana-namespaces-robot-shop.png)

1. Click on the **Pods tab** and choose the **Map** view:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/instana-pods-map.png)
...
1. Analyze the CPU Limits, CPU Requests, Memory Limits, and Memory Requests. You
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/instana-map-cpu-limits.png)

1. Navigate back to the Turbonomic ARM dashboard and navigate to the **Robot
   Shop** application:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/action-4.png)
...
1. Here, we can see some key application metrics provided by Instana, e.g.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/action-5.png)
...
1. Click the **Container Cluster** entity and it will take you to a screen like
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/action-6.png)
...
1. Click **SHOW ALL** in the **Pending Actions** section:
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/action-7.png)
...
1. Pick one action and select **Details** to see what the action is suggesting.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/turbo-action-payment-details.png)
...
1. Select the checkbox for the pending action you just viewed the details for.
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/action-8.png)

1. Click on **EXECUTE NOW** on the resulting pop up window:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/action-9.png)

1. You should see the action has successfully executed - a green checked mark:

   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/turbo-action-payment.png)
...
1. After a few minutes, you can go back to the Instana dashboard to view the
   ...
   ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/turbonomic/policies-and-taking-actions-lab/4-taking-actions/images/turbo-action-taken-payment.png)
