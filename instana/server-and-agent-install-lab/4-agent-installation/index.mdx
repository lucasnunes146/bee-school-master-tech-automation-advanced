...
![architecture-agent-instana-vm](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/architecture-agent-instana-vm.png)
...
![architecture-agent-mqace-vm](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/architecture-agent-mqace-vm.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/deploy-agent.png)
...
![instana-default-login](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/agent-deployment.png)
...
![install command](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/install-command.png)
...
![architecture-agent-kubernetes](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/architecture-agent-kubernetes.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/go-to-instana-agents.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/agent-deploy-k8s-helmchart.png)
...
- **Agent Zone**: `Demo Apps`
  ...
  - Ensure you click the **Add "Demo Apps"** popup to set the zone name:
    ...
    ![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/add-agent-zone.png)

![agent-helm-deployment](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/agent-helm-deployment.png)
...
![infrastructure-menu](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/infrastructure-menu.png)

Toggle on the live view:

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/infra-live-view.png)
...
![show-five-vms](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/instana/server-and-agent-install-lab/4-agent-installation/images/show-five-vms.png)
