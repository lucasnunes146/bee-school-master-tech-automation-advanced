...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/unlock-jenkins.png) 

On the *Customize Jenkins* window, select **Install suggested plugins**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/install-plugins.png)

After the plugins are installed, skip the *Create First Admin User* window by clicking **Skip and continue as admin**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/continue-as-admin.png)

On the *Instance Configuration* window, don't change the default URL and just click **Save and Finish**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/save-and-finish.png)

On the *Jenkins is ready* window, click **Start using Jenkins**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/start-using-jenkins.png)
...
We will create a Jenkins pipeline to build and deploy the **qotd** application.

On the **Welcome to Jenkins!** window, click on **Create a job**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/create-job.png)

In the **New Item** page under **Enter an item name** field, type `Build and Deploy`. Select **Pipeline** and click **OK**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/new-item.png)
...
pipeline {
    ...
    stages {
        ...
        stage('Deploy the application into the K8 cluster') {
            steps {
                sh '''
                    # Deploy application
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/pipeline.png)
...
1. Checkout Code: this stage clones the GitHub repository that contains the code for the **qotd** application.
...
:::note 
The first build can take up to 10 minutes to run because it needs to download all the required dependencies and build multiple container images.
Subsequent builds will be a bit faster because some dependencies will be cached.
:::

After the build is finish, you should see a green check next to the build number indicating that the build was successful.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/build-now.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/instana-k8s-cluster.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/instana-new-app-step1.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/instana-new-app-step2.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/instana-new-app-step3.png)


All right! The application perspective has been created. On the top-right, click on the **Live** button to enable live data feeds. After a couple of minutes, 
you should see the Summary page get populated with data. 

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/instana-app-summary.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/instana-app-vulnerabilities.png)
...
Now we will prompt Concert to receive the application information (SBOM) from Instana.
...
created in the previous section. Click the 3-dots menu on the right and select **Run now** to prompt Concert to pull application configuration from Instana.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-run-ingestion.png)

Wait a few seconds for the ingestion job to complete. Refresh the page to see the status of the job. 
When the job is completed, you should see a **Success** status. 


From the left menu, go to **Inventory > Application inventory** and confirm you see the **qotd** application listed. 
Note that you will also see an **All Services** application listed. This is an auto-defined application that is present by default when Instana is first deployed
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-evidence-store.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-app-inventory.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-app-details.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-app-edit.png)

On the **Edit details** window, under **Criticality**, select **High**. Under **Data sensitivity**, select **High**. under **Revenue per hour ($)**, type `500`.
Under **Description**, type `Quote of the day application`. On **Add business details**, select **Yes**.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/edit-popup0.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/edit-popup2.png)

Click **Save** to save the changes.

On the *SBOMs* tab, note that the latest SBOM file received from Instana is listed.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-app-sbom.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-sbom-details2.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-build-artifacts.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/vulnerability/5-app-build-deploy/images/concert-cves.png)

Congratulations! You have successfully built and deployed the **qotd** application using Jenkins, defined the application in Instana,
