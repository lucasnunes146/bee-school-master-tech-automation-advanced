...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/cw-save-workflow-with-configs.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/cw-job-creation-certificateRenewal-part1.png)
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/cw-job-creation-certificateRenewal-part2.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-certificate-serial-number.png) 
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-renewal-trigger-certificate-ui.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-renewal-trigger-parameters.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-certificate-serial-number-intermediate.png) 

* You will get into **Keystore entries UI** for a Certificate after performing previous action. We will be using **the Certificate Serial Number** in subsequent step. Copy **the Certificate Serial Number** into a text file.
Click **Renew** option.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-renewal-trigger-intermediate-certificate-ui.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-renewal-trigger-parameters-rejected.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/github-issues-with-approved-rejected-labels.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/cw-certificateRenewal-job-schedule-log.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/github-issue-apache-tomcat-cert-closed.png)

The github issue for the certificate with the serial number labeled as `rejected` is still `Open` and has no change.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/github-issue-intermediate-cert-opened.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/cw-run-workflow.png)

* The workflow will complete its execution and return **202 Accepted** as message in **Logs** section below 

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/cw-jks-certdiscovery-execution.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/concert-tomcat-cert-renewed.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-settings.png)

* Click **Privacy & Security** section on left panel
* Click **View Certificates...** button

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-privacy-security-view-certificates.png)

* Click **Authorities** tab
* Click **Import** button

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-authorities-import.png)

* Browse to **Downloads** folder
* Select **intermediate.pem** and **ca.pem** to import

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-import-intermediateca-ca.png)

* Click the two check boxes appear in the dialog box
  - Trust this CA to identify websites.
  - Trust this CA to identify email users.

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-downloading-certs-checkboxes.png)

You will see the 2 certificates imported successfully similar to the screenshot below. 

![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-two-certs-import-success.png)
...
![](https://raw.githubusercontent.com/IBM/waiops-tech-jam/main/labs/concert/op-certificate-mgmt/6-certificate-renewal-javaKeyStore/images/firefox-demo-apps-padlock-trusted.png)
